...
export default function QuestionContainer() {
  ...
  function handleQuestionSubmit(e: React.MouseEvent<HTMLButtonElement>) {
    (async () => {
      const prompt =
        "Context: Answer the question as a " +
        (e.target as HTMLButtonElement).value +
        " know it all and keep responses to no more than 75 words. Question: " +
        question;
  ...
  return (
    <>
      <div className={styles.questionContainer}>
        ...
        <input
          className={styles.questionContainerBox}
          type="text"
      ...
      <div className={styles.answerContainer}>
        ...
        <p className={styles.answerContainerBox}>{answer}</p>
      </div>
    </>
  );
}
